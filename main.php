    ...
    <nav class="navbar is-info">
      ...
      <div id="navbarMenu" class="navbar-menu">
        <div class="navbar-end is-font has-text-weight-bold">
          <a href="main.php" class="navbar-item hover-underline">Home</a>
          <a href="PAGES/gallery.php" class="navbar-item hover-underline">Gallery</a>
          <a href="PAGES/about.php" class="navbar-item hover-underline">About</a>
          <a href="PAGES/contact.php" class="navbar-item hover-underline">Contact</a>
        </div>
      </div>
    </nav>
  </header>
    ...
    <section class="hero is-medium is-primary">
      <div class="hero-body">
        <div class="container has-text-centered">
          ...
          <a href="/PAGES/gallery.html" class="button is-large is-white pulsating-outline">Browse Gallery</a>
        </div>
      </div>
    </section>
        ...
        <div class="card">
          <div class="card-image">
            <figure class="image is-16by9">
              <img src="IMAGE/7bdce75d64ba8f75d7b71b14b23e411e.jpg" alt="Featured Artwork" />
            </figure>
          </div>
          <div class="card-content">
            <div class="media">
              <div class="media-content">
                <p class="title is-4">Sunset in the Sea</p>
                <p class="subtitle is-6">By Mo Yaseen</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="section">
      <div class="container">
        ...
        <div class="has-text-centered">
          <a href="PAGES/gallery.html" class="button is-primary is-large is-outlined button-3d pulsating-outline">View Full Gallery</a>
        </div>
      </div>
    </section>
